...
## For use with Windows Server 2012 & 2012R2. Windows Server 2016 or later requires a slightly different script. 
## This script takes a preloaded SUSDB mdf and ldf (i.e did the inital products and classification sync), attaches it to the local SQl install (default instance).
